...
//    static let coordinator = CoreData
//    
//    // MARK: - Core Data stack
//    
//    static var coordinator: NSPersistentStoreCoordinator = {
//        let model = NSManagedObjectModel(byMerging: [NSManagedObjectModel]?)
//        let coordinator = NSPersistentStoreCoordinator(managedObjectModel: <#T##NSManagedObjectModel#>)
//    }()
//    
    ...
    static func saveLocationToDB(coordinates: CLLocationCoordinate2D) -> Location {
        ...
        location.created_at = NSDate() as Date
